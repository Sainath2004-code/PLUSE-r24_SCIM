...
export const AdminLayout: React.FC = () => {
    ...
    if (loadingAuth || !admin) return null;
    ...
    return (
        <div className="flex h-screen bg-slate-50 dark:bg-slate-950 font-inter overflow-hidden premium-scrollbar">
            ...
            <aside className={`${sidebarOpen ? 'translate-x-0 w-64' : '-translate-x-full w-0 md:translate-x-0 md:w-20'} absolute md:relative h-full transition-all duration-300 bg-slate-900 dark:bg-slate-950/50 backdrop-blur-sm border-r border-slate-200 dark:border-white/5 flex flex-col shrink-0 z-[60]`}>
