...
AT LEAST ONE tag MUST be from this primary category list: Fire incidents, Political Violence, Civil Disturbances, Terrorist attack / incident, Critical Infrastructure accident, Power grid, Diplomatic Visits, Major Upcoming events, Public announcement, Cyber attacks, National Threat, VIP movements, Protest, Elections, long term issue (updates & Monitoring), Natural Hazards, Travel Risk, Health Risk, Monitoring.
Return ONLY a JSON array of string tags, no explanation.
Example: ["Elections", "Voting", "Polling Booth", "Security Setup"]
