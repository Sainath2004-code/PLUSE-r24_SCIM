    ...
    return (
        <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white shadow-md py-2' : 'bg-transparent py-4'}`}>
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                {/* 3-column header: [RRU Logo] | [PULSE-R24 Center] | [PGDSCIM Logo] */}
                <div className="grid grid-cols-3 items-center">
                    ...
                    <div className="flex justify-center">
                        <Link to="/" className="flex flex-col items-center">
                            <h1 className={`font-clarendon text-2xl md:text-3xl font-black tracking-tight leading-none text-center ${scrolled ? 'text-maroon-600' : 'text-intel-900'}`}>
                                PULSE-R<sup className="text-lg">24</sup>
                            </h1>
                            <span className="text-[9px] uppercase font-inter font-semibold tracking-widest text-gray-500 mt-1 text-center">
                                ISSP | RRU Puducherry
                            </span>
                        </Link>
                    </div>
