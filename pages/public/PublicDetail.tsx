...
import {
    ...
    Twitter, Linkedin, AlertTriangle, BookOpen
} from 'lucide-react';
                ...
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    <div className="flex items-center gap-2 mt-4 print:hidden">
                        ...
                        <a
                            ...
                            target="_blank" rel="noreferrer"
                            className="flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-bold text-gray-600 bg-white border border-gray-200 rounded-lg hover:bg-blue-700 hover:text-white hover:border-blue-700 transition-all"
                        >
